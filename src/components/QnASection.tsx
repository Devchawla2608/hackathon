...
const faqs: FAQItem[] = [
  {
    question: 'What types of databases does SQLVision support?',
    answer: 'SQLVision currently supports Snowflake, PostgreSQL, MySQL, and SQL Server databases. We\'re continuously adding support for more database types.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, you can edit any generated SQL query before execution. SQLVision provides a full SQL editor with syntax highlighting and auto-completion to help you refine queries when needed.'
  },
  {
  ...
  },
  {
    ...
    answer: 'SQLVision supports CSV, Excel (.xlsx), JSON, and Parquet files for direct upload to Snowflake. Files are automatically parsed and converted into tables based on their structure.'
  },
  {
